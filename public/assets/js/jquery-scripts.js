 ...
 */
! function(a) {
    "object" == typeof exports ? a(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], a) : a(jQuery)
}(function(a) {
    a.extend({
        bez: function(b, c) {
            if (a.isArray(b) && (c = b, b = "bez_" + c.join("_").replace(/\./g, "p")), "function" != typeof a.easing[b]) {
                var d = function(a, b) {
                    var c = [null, null],
                        d = [null, null],
                        e = [null, null],
                ...
                a.easing[b] = function(a, b, e, f, g) {
                    return f * d([c[0], c[1]], [c[2], c[3]])(b / g) + e
                }
            }
            return b
        }
