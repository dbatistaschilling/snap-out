  ...
  <div id="home">
    <div id="masterslider-band" className="master-slider ms-skin-default slider-border">
      <div className="ms-slide">
        <img src="assets/masterslider/blank.gif" data-src="assets/img/slider/musician-music-band-slide-01.jpg" alt="Musician HTML template for music industry - musicians, bands and music blogs" />
      ...
      <div className="ms-slide">
        <img src="assets/masterslider/blank.gif" data-src="assets/img/slider/musician-music-band-slide-02.png" alt="Musician HTML template for music industry - musicians, bands and music blogs" />
        <h2 className="ms-layer pi-caption" style={{left: '350px', top: '350px'}} data-type="text" data-effect="bottom(20)" data-duration={500} data-hide-effect="fade" data-delay={1700}>
          Snap - Out
        </h2>
        <h2 className="ms-layer pi-caption-02" style={{left: '200px', top: '475px'}} data-type="text" data-effect="fade" data-duration={500} data-hide-effect="fade" data-delay={1400}>
      ...
      <div className="ms-slide">
        <img src="assets/masterslider/blank.gif" data-src="assets/img/slider/musician-music-band-slide-03.png" alt="Musician HTML template for music industry - musicians, bands and music blogs" />
        <h2 className="ms-layer pi-caption" style={{left: '350px', top: '350px'}} data-type="text" data-effect="bottom(20)" data-duration={500} data-hide-effect="fade" data-delay={1700}>
          Snap - Out
        </h2>
        <h2 className="ms-layer pi-caption-02" style={{left: '200px', top: '475px'}} data-type="text" data-effect="fade" data-duration={500} data-hide-effect="fade" data-delay={1400}>
